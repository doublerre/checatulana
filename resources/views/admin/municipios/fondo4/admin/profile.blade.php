    ...
    <div class="modal-dialog">
       <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('fondo4.uploadCFDIsUA') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
        ...
        $(document).ready(function(){
            ...
            function getCFDIs()
            {
                $("#cfdis").DataTable({
					...
					ajax: {
						method: "GET",
						url: "{{route('fondo4.cfdis', $user->id)}}",
					},
					columns: [
						{data: "view_pdf_m"},
						{data: "view_pdf"},
