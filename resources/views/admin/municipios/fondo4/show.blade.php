                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Fecha de subida: </b><a class="float-right" style="color:green">{{$fondo4->created_at->diffForHumans()}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Ultima modificación: </b><a class="float-right" style="color:green">{{$fondo4->updated_at->diffForHumans()}}</a>
                            </li>
                            @if ($fondo4->file == "EN ESPERA...")
                            <li class="list-group-item">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <p align="center">
                            <iframe src="{{Storage::url($fondo4->file_user)}}#toolbar=0" width="90%" height="600px">
                            </iframe>
                        </p>
                    </div>
                    <!-- /.card-body -->
                ...
                @else
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <p align="center">
                                <iframe src="{{Storage::url($fondo4->file)}}#toolbar=0" width="90%" height="600px">
                                </iframe>
                            </p>
                        </div>
                        <!-- /.card-body -->
    ...
    <div class="modal-dialog">
       <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('fondo4.uploadCFDIsUM', $fondo4->id) }}" method="POST" enctype="multipart/form-data">
                {{ method_field('PUT') }}
                {{ csrf_field() }}
